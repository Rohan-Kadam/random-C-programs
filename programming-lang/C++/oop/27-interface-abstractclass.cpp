/*
 *
 * DONOT confuse with abstraction. 
 * This is abstract class also known as Interface. A class with pure virtual function
 *
 * RULES
...
public:
   ...
   //No implementation needed as everyones sound is different.

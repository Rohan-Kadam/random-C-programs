...
*/
//RHK
 #define DESTMAC0	0xe0
 #define DESTMAC1	0x9d
 #define DESTMAC2	0x31
 #define DESTMAC3	0x0c
 #define DESTMAC4	0x3f
 #define DESTMAC5	0xa8

//RHK  
//#define destination_ip 10.240.253.10
#define destination_ip 192.168.0.22
...
/****** OR
	...
	iph->daddr	= inet_addr("192.168.0.22"); // put destination IP address

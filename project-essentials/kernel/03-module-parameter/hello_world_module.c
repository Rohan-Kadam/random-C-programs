 ...
 * @ops: the set & get operations for this parameter. (Check const struct kernel_param_ops in CODE)
 * @arg: args for @ops
 * @perm: visibility in sysfs.
 *
 * The ops can have NULL set or get functions.
 *
 * FROM:- https://elixir.bootlin.com/linux/latest/source/include/linux/moduleparam.h#L175
 */

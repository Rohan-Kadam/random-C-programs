...
===================================================================
STEPS TO GENERATE PROFILING DATA :-
===================================================================
1> gcc -pg -o testGprof testGprof.c

2> ./testGprof

3> gprof -b TestGprof gmon.out > analysis.out
(RUN without -b to print the verbose blurbs that try to explain the meaning of all of the fields in the tables)
(Explore other options using --help)

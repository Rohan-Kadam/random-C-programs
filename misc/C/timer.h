...
//    timer_id start_repeat(uint64_t period, const handler_type& handler);
//    timer_id start(uint64_t period, const handler_type& handler);
//    timer_id start_repeat(uint64_t period, handler_type&& handler);
//    timer_id start(uint64_t period, handler_type&& handler);

//    timer_id create(uint64_t period, const handler_type& handler, bool repeat, bool is_arg, str_argument argument);
//    timer_id create(uint64_t period, handler_type&& handler, bool repeat, bool is_arg, str_argument argument);
